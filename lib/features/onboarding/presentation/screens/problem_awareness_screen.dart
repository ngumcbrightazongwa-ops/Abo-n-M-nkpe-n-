...
class _ProblemAwarenessScreenState extends State<ProblemAwarenessScreen> {
  ...
  Widget build(BuildContext context) {
    final options = const [
      ...
      (
        'I know some basics',
        'I can say simple phrases.',
        Icons.sentiment_satisfied_outlined,
      ),
      (
        "I’m conversational",
        'I can hold short conversations.',
        Icons.sentiment_very_satisfied_outlined,
      ),
      ("I’m advanced", "I’m comfortable speaking Nkwen.", Icons.star_border),
    ];
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      const _StepIndicator(count: 5, index: 2),
                      const Spacer(),
                  ...
                  Transform.translate(
                    ...
                    child: SizedBox(
                      height: (MediaQuery.sizeOf(context).height * 0.33).clamp(
                        210.0,
                        310.0,
                      ),
...
class _FeelIcon extends StatelessWidget {
  final IconData icon;

  const _FeelIcon({required this.icon});
...
class _FeelTitle extends StatelessWidget {
  const _FeelTitle();
